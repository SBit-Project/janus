...
Client side transaction signing is supported underneath it uses [sbit-ethers-wrapper](https://github.com/SBit-Project/sbit-ethers) to construct raw transactions

See [truffle unbox SBit-Project/react-box](https://github.com/SBit-Project/react-box) for an example truffle-config file

## Ethers support

Ethers is supported, use [sbit-ethers-wrapper](https://github.com/SBit-Project/sbit-ethers)
