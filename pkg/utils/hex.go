...
// Converts Sbit address to an Ethereum address
func ConvertSbitAddress(address string) (ethAddress string, _ error) {
	...
	// Drop Sbit chain prefix and checksum suffix
