...
func TestGetStorageAtRequestWithNoLeadingZeros(t *testing.T) {
	...
	getStorageResponse := sbit.GetStorageResponse{}
	...
	err = mockedClientDoer.AddResponseWithRequestID(2, sbit.MethodGetStorage, getStorageResponse)
	if err != nil {
		t.Fatal(err)
	}

	//preparing proxy & executing request
	proxyEth := ProxyETHGetStorageAt{sbitClient}
