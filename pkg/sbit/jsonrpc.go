...
func (err *JSONRPCError) Error() string {
	return fmt.Sprintf("sbit [code: %d] %s", err.Code, err.Message)
}
...
var (
	...
	// taken from https://github.com/SBit-Projectt/sbit/blob/master/src/rpc/protocol.h
	...
	ErrSbitWorkQueueDepth = errors.New("Work queue depth exceeded")
	// Sometimes truffle is too quick for sbitd and truffle gives up after one error
	// couldn't proxy eth_blockNumber request: Client#do: Post \"***sbit:22002\": dial tcp: lookup sbit: Try again
