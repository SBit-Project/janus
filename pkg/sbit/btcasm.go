...
func ParseCallSenderASM(parts []string) (*ContractInvokeInfo, error) {
	// See: https://github.com/SBit-Project/qips/issues/6
...
func ParseCreateSenderASM(parts []string) (*ContractInvokeInfo, error) {
	// See: https://github.com/SBit-Projectt/qips/issues/6
	// https://blog.sbit.org/sip-5-add-op-sender-opcode-571511802938
