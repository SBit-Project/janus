...
var DefaultGasAmountForSbit = big.NewInt(250000)

// SBIT default gas value (also the minimum gas) in wei
...
func (r *SendTransactionRequest) UnmarshalJSON(data []byte) error {
	...
	*r = SendTransactionRequest(params[0])
	...
	if r.Gas == nil {
		...
		// SBIT: (numeric or string, optional) gasLimit, default: 250000, max: 40000000
		r.Gas = &ETHInt{DefaultGasAmountForSbit}
	}

	if r.GasPrice == nil {
		// ETH: (optional, default: To-Be-Determined) Integer of the gasPrice used for each paid gas
		// SBIT: (numeric or string, optional) gasPrice Sbit price per gas unit, default: 0.0000004, min:0.0000004
